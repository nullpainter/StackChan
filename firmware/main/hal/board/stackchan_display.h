...
public:
    ...
    // Picks up the chat and speech colours from settings. Static because the
    // colours are process-wide and the setup menu applies them before any
    // display instance exists.
    static void ReloadLedColors();
